...
const MultiVitamin = () => {
    ...
    // Filter products belonging to the "MultiVitamin" category
    const multiVitaminProducts = product.filter(item => item.category === "Multi-Vitamin");
    ...
    return (
        ...
        <div className="container mx-auto px-5 py-8 md:py-16">
            ...
            <h1 className="m:text-3xl text-4xl font-medium title-font mb-2 text-gray-900 text-center" style={{ color: mode === 'dark' ? 'white' : '' }}>Multi-Vitamin</h1>
            ...
            <div className="flex flex-wrap -m-4">
                {multiVitaminProducts.map((item, idx) => (
