...
const PreWorkout = () => {
    ...
    // Filter products belonging to the "PreWorkout" category
    const preWorkoutProducts = product.filter(item => item.category === "Pre-Workout");
    ...
    return (
        ...
        <div className="container mx-auto px-5 py-8 md:py-16">
            ...
            <h1 className="m:text-3xl text-4xl font-medium title-font mb-2 text-gray-900 text-center" style={{ color: mode === 'dark' ? 'white' : '' }}>Pre-Workout</h1>
            ...
            <div className="flex flex-wrap -m-4">
                {preWorkoutProducts.map((item, idx) => (
