...
const HydrolizedProtein = () => {
    ...
    // Filter products belonging to the "Hydrolized Protein" category
    const hydrolizedProteinProducts = product.filter(item => item.category === "Hydrolized Protein");
    ...
    return (
        ...
        <div className="container mx-auto px-5 py-8 md:py-16">
            ...
            <h1 className="m:text-3xl text-4xl font-medium title-font mb-2 text-gray-900 text-center" style={{ color: mode === 'dark' ? 'white' : '' }}>Hydrolized Protein</h1>
            ...
            <div className="flex flex-wrap -m-4">
                {hydrolizedProteinProducts.map((item, idx) => (
...
export default HydrolizedProtein;
