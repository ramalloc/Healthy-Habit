...
const WheyProtein = () => {
    ...
    // Filter products belonging to the "Whey Protein" category
    const wheyProteinProducts = product.filter(item => item.category === "Whey Protein");
        ...
        <Layout>
            <div className="container mx-auto px-5 py-8 md:py-16">
                ...
                <div className="flex justify-center mb-8">
                    <img
                        src="https://cdn.pixabay.com/photo/2021/11/01/07/36/whey-6759621_1280.jpg"
                        alt="Description of the image"
                        className="mx-auto h-60"
                    />
                </div>
                {/* Heading for the category */}
                <h1 className="m:text-3xl text-4xl font-medium title-font mb-2 text-gray-900 text-center" style={{ color: mode === 'dark' ? 'white' : '' }}>Whey Protein</h1>
                ...
                <div className="flex flex-wrap -m-4">
                    {wheyProteinProducts.map((item, idx) => (
