...
const EAA = () => {
    ...
    // Filter products belonging to the "EAA" category
    const eaaProducts = product.filter(item => item.category === "EAA");
    ...
    return (
        ...
        <div className="container mx-auto px-5 py-8 md:py-16">
            ...
            <h1 className="m:text-3xl text-4xl font-medium title-font mb-2 text-gray-900 text-center" style={{ color: mode === 'dark' ? 'white' : '' }}>EAA</h1>
